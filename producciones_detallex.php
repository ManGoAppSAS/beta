...
<main class="rdm--contenedor-toolbar">
    ...
    <input type="search" name="busqueda" id="busqueda" value="<?php echo "$consultaBusqueda"; ?>" placeholder="Buscar componente a producir" maxlength="30" autofocus autocomplete="off" onKeyUp="buscar();" onFocus="buscar();" />
