...
else
{
    ...
    $insercion = $conexion->query("INSERT INTO ventas_datos values ('', '$ahora', '', '$sesion_id', '$sesion_local_id', '$ubicacion_id', '$ubicacion', '0', '1', 'efectivo', 'ocupado', '0', '0', '0', '0', '10', '0', '', '', 'contado', '$ahora')");
...
while ($contador_pedido < $cantidad_pedido)
{
    ...
    {
        $insercion = $conexion->query("INSERT INTO ventas_productos values ('', '$ahora', '$sesion_id', '$venta_id', '$ubicacion_id', '$ubicacion', '$categoria_id', '$categoria', '$sesion_local_id', '$zona','$producto_id', '$producto', '$precio_final', '$impuesto_porcentaje', 'pedido')");
